...
const Cone = ({position, size, color}: {position: [number, number, number]; size: [number, number, number]; color: string}) => {
  return (
  <mesh position={position}>
...
*/
const Sphere = ({position, size}: {position: [number, number, number]; size: [number, number, number]; color: string}) => {
  const ref = useRef();
...
const Torus = ({position, size, color}: {position: [number, number, number]; size: [number, number, number, number]; color: string}) => {
  return (
    <mesh position={position}>
...
export default function App() {
  return (
      <Canvas>  
        ...
        <Cube position={[-9,-2,-14]} size={[2,2,2]} color={"gray"} />
        <Torus position={[-9, 0, -14]} size={[0.9, 0.1, 30, 30]} color={"purple"}/>
      </Canvas>
  );
  }